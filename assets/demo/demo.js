demo = {
  ...
  showNotificationWarn: function(from, align) {
    color = 'warning';

    $.notify({
      icon: "nc-icon nc-bell-55",
      message: "Nom d'Utilisateur/Mot de passe Incorrecte ..."
  ...
  showNotificationSuccess: function(from, align) {
    color = 'success';

    $.notify({
      icon: "nc-icon nc-bell-55",
      message: "Identification acceptée ..."
